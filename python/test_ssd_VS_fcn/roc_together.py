...
prob_thres = [0.3, 0.4, 0.5, 0.6, 0.7, 0.8,
...
def parse_args():
	...
	parser.add_argument('--pred1_dir', dest='pred1_dir', help='pred_FCN dir', type=str)
	parser.add_argument('--pred2_dir', dest='pred2_dir', help='pred_SSD_model1 dir', type=str)
	parser.add_argument('--pred3_dir', dest='pred3_dir', help='pred_SSD_model2 dir', type=str)
...
#		sheet_0 = file.get_sheet(table["face_6"])
	...
	file.save("{}/SSD_VS_FCN.xlsx".format(args.save_dir))  #save xlsx
...
if __name__ == "__main__":
	...
	plt.ylabel("recall")
	plt.title("SSD_VS_FCN_Facedetect_iou[0.5]_scale[0-1000]")
	...
	plt.legend( ["FCN","SSD_model1","SSD_model2"], loc = "upper left")
	plt.savefig("{}/SSD_VS_FCN.png".format(args.save_dir))
	save_xlsx()
