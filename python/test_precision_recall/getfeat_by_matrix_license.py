...
def download(i, j):
    ...
    fobj = open("%s/feature_licensecard100.list.1822" % j, "a+")
...
def getFeatreFrommatrix(matrixSession=None, imageUrl="http://192.168.2.164:8501/api/file/6,06ba23581a"):
    ...
    post_source = {"Context":{"SessionId":"test face single","Type":2,"Functions":[200,201,202,203,204,205]},"Image":{"Data":{"URI":"file://"+imageUrl}}}
